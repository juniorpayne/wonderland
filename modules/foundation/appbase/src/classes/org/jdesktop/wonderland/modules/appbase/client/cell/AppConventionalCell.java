...
public abstract class AppConventionalCell extends App2DCell {
    ...
    private void startTheSlave (String connectionInfo) {
        //fixme:
       // connectionInfo.replace('172.31.26.48', '3.138.182.243')
        logger.warning("Before connectionInfo. " + connectionInfo);
        connectionInfo = connectionInfo.replace("172.31.26.48","3.138.182.243");
        logger.info("Starting app slave.");
        logger.warning("Starting app slave. " + connectionInfo);
